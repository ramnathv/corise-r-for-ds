...
knitr::opts_knit$set(
  upload.fun = imgur_upload_v2, base.url = NULL
)
```
...
One of the biggest strengths of R is its extensive ecosystem of __packages__. An R package is a suite of functions along with data and documentation, that extends the functionality of base R. 

The Tidyverse is a highly opinionated set of packages that share a common underlying grammar and philosophy and are designed to work together to execute the data science workflow.
