...
In this course, we will focus on `ggplot2`, as it provides us with a highly systematic grammar to create complex visualizations in a flexible
manner.


### Diamonds

The journey of every visualization begins with the data. We will use
the `diamonds` dataset that ships with the `ggplot2` package to explore the amazing world of data visualization!
...
For more information about the `diamonds` dataset, please run `? diamonds` in your
R console.
...
We can write the code for the plot above more concisely by moving the `aes` mapping
inside the `ggplot()` call. This is the idiomatic way to write `ggplot2` code and we will use it going forward.
