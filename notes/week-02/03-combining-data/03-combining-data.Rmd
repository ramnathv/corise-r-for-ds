...
Data is often spread across multiple tables, and __combining__ them is a common operation. This is where the `join` and `bind` functions in `dplyr` comes into play. 
