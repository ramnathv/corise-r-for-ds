...
[`ggplot2`](https://ggplot2.tidyverse.org) is an R package that implements the Grammar of Graphics. It provides a powerful and flexible system for creating a wide variety of plots, including scatterplots, line plots, bar charts, histograms, and more. The ggplot2 syntax is designed to be intuitive and easy to use, allowing users to quickly create complex visualizations with just a few lines of code.


```{r grammar-of-graphics-pyramid, echo = FALSE, out.width = "100%"}
knitr::include_graphics(
  path = "https://carpentries-incubator.github.io/open-science-with-r/img/pyramid-grammar-graphics.png"
)
```
